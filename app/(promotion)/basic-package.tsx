// app/(promotion)/basic-package.tsx
...
const BasicPackageDetails = () => {
    ...
    const handleUpgradePress = () => {
        if (packageData) {
            ...
            router.push({
                pathname: '/(payment)/payment-method', // Đây là đường dẫn đến màn hình mới
                params: { premiumPackageId: packageData.id, packageName: packageData.name } // Truyền ID và tên gói
            });
        } else {
            // Xử lý trường hợp không có packageData (ví dụ: hiển thị alert)
            ...
            <View style={styles.cardWrapper}>
                <View style={styles.cardContainer}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={handleUpgradePress} // GỌI HÀM MỚI TẠI ĐÂY
                    >
...
const styles = StyleSheet.create({
    ...
    upgradeButton: {
        ...
        color: Colors.light.whiteText, // Text color for the button
        backgroundColor: Colors.light.primaryText,
        paddingVertical: 8,
    ...
    upgradeButtonText: { // Style for the text INSIDE the button
        fontSize: 16,
        color: Colors.light.whiteText,
        textAlign: 'center',
    }
